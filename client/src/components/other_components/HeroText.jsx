...
export function TypewriterEffectSmootha({nickName}) {
    const words = [
        {text: "Welcome-", className:"font-vt323 text-4xl "},
        {
            text: nickName,
    ...
    return (
        <div className="flex flex-col items-center justify-center -m-7 ">
            ...
            <div className="flex flex-col md:flex-row pt-5 space-y-3 m:space-y-0 space-x-0 md:space-x-4">
