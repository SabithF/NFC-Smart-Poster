...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      ...
      { image: `https://images.pexels.com/photos/167491/pexels-photo-167491.jpeg`, text: "15th Sep" },
      { image: `https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg`, text: "30th Jul" },
      { image: `https://images.pexels.com/photos/196652/pexels-photo-196652.jpeg`, text: "15th Sep" },
      { image: `https://images.pexels.com/photos/167491/pexels-photo-167491.jpeg`, text: "15th Sep" },
...
export default function CircularGallery({
  ...
  textColor = "#ffffff",
  borderRadius = 0.05,
  font = "bold 30px 'Brigada', sans-serif",
  scrollSpeed = 2,
  scrollEase = 0.05,
}) {
  ...
  return <div className="w-full h-full overflow-hidden font-brigada cursor-grab active:cursor-grabbing" ref={containerRef} />;
}
